...
namespace InstituteWebAPI.Migrations
{
    ...
    [Migration("20260207195600_AddFeeCollectionModule")]
    partial class AddFeeCollectionModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstituteWebApp.Models.Domain.FeeCollection", b =>
                {
            ...
            modelBuilder.Entity("InstituteWebApp.Models.Domain.FeeCollectionDetail", b =>
                {
                    b.Property<Guid>("FeeCollectionDetailID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("FeeCollectionDetailID");

                    b.HasIndex("FeeTypeID");

                    b.HasIndex("FeeCollectionID", "FeeTypeID", "Month", "Year")
                        .IsUnique()
                        .HasFilter("[Month] IS NOT NULL AND [Year] IS NOT NULL");

                    b.ToTable("FeeCollectionDetails");
                });
            ...
            modelBuilder.Entity("InstituteWebApp.Models.Domain.FeeCollectionDetail", b =>
                {
                    b.HasOne("InstituteWebApp.Models.Domain.FeeCollection", "FeeCollection")
                        .WithMany("FeeCollectionDetails")
                        .HasForeignKey("FeeCollectionID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InstituteWebApp.Models.Domain.FeeType", "FeeType")
                        .WithMany()
            ...
            modelBuilder.Entity("InstituteWebApp.Models.Domain.FeeCollection", b =>
                {
                    b.Navigation("FeeCollectionDetails");
                });
